# This script generates a Meeting (IETF 999) with Rooms, TimeSlots, Sessions and Constraints.
# It is meant to support the development of the Automatic Schedule Builder, by
...
from ietf.meeting.models import Meeting, Room, Constraint, Session, ResourceAssociation, TimeSlot, SchedulingEvent
